...
function c100000009.tg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	local sg=Duel.GetMatchingGroup(Card.IsAbleToDeck,tp,0,LOCATION_GRAVE+LOCATION_MZONE+LOCATION_SZONE+LOCATION_HAND,nil)
	Duel.SetOperationInfo(0,CATEGORY_TODECK,sg,sg:GetCount(),0,0)
	local sg=Duel.GetMatchingGroup(Card.IsAbleToDeck,1-tp,0,LOCATION_GRAVE+LOCATION_MZONE+LOCATION_SZONE+LOCATION_HAND,nil)
	Duel.SetOperationInfo(0,CATEGORY_TODECK,sg,sg:GetCount(),0,0)
end
