...
function c100412016.spfilter(c,e,tp)
	return c:IsSetCard(0x128) and not c:IsCode(100412016) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c100412016.tgfilter(c)
	return c:IsSetCard(0x128) and not c:IsCode(100412016) and c:IsAbleToGrave()
end
