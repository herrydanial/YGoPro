...
function c91500017.filter(c)
	return (aux.IsCodeListed(c,15259703) or c:IsCode(15259703) or aux.IsCodeListed(c,43175858) or c:IsCode(43175858)) and not c:IsCode(91500017) and c:IsAbleToHand()
end
...
function c91500017.repfilter(c,tp)
	return c:IsFaceup() and c:IsControler(tp) and c:IsLocation(LOCATION_ONFIELD) and (c:IsCode(15259703) or c:IsCode(43175858))
