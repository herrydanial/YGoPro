...
--Slow Life
--Script by nekrozar
function c100217024.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetCondition(c100217024.condition)
	c:RegisterEffect(e1)
	--summon limit
	...
	e2:SetTarget(c100217024.sumlimit1)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	...
	e4:SetTarget(c100217024.sumlimit2)
	c:RegisterEffect(e4)
end
function c100217024.condition(e,tp,eg,ep,ev,re,r,rp)
