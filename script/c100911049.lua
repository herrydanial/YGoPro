...
function c100911049.ctcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local rt=math.min(Duel.GetMatchingGroupCount(c100911049.ctfilter,tp,0,LOCATION_MZONE,nil),Duel.GetLocationCount(tp,LOCATION_MZONE),c:GetOverlayCount(),3)
...
function c100911049.ctop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c100911049.ctfilter,tp,0,LOCATION_MZONE,ct,ct,nil)
