--灰流うらら
function c14558128.initial_effect(c)
	--negate
	...
	e1:SetCountLimit(1,14558128)
	e1:SetCondition(c14558128.discon)
	e1:SetCost(c14558128.discost)
	e1:SetTarget(c14558128.distg)
	e1:SetOperation(c14558128.disop)
	c:RegisterEffect(e1)
end
function c14558128.discon(e,tp,eg,ep,ev,re,r,rp)
...
function c14558128.discost(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
	if chk==0 then return c:IsDiscardable() end
	Duel.SendtoGrave(c,REASON_COST+REASON_DISCARD)
end
function c14558128.distg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return not re:GetHandler():IsStatus(STATUS_DISABLED) end
	Duel.SetOperationInfo(0,CATEGORY_DISABLE,eg,1,0,0)
end
function c14558128.disop(e,tp,eg,ep,ev,re,r,rp)
