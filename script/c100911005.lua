...
function c100911005.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(100911005,2))
...
function c100911005.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SpecialSummon(c,0,tp,tp,false,false,POS_FACEUP)~=0 then
		c:RegisterFlagEffect(100911005,RESET_EVENT+0x1ec0000+RESET_PHASE+PHASE_BATTLE,0,1)
...
function c100911005.sccon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(100911005)~=0
end
