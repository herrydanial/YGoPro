...
--Script by nekrozar
function c100911027.initial_effect(c)
	c:EnableReviveLimit()
	--special summon
	...
	e1:SetCondition(c100911027.spcon)
	e1:SetOperation(c100911027.spop)
	c:RegisterEffect(e1)
	...
	e4:SetDescription(aux.Stringid(100911027,0))
	e4:SetCategory(CATEGORY_TODECK)
	e4:SetType(EFFECT_TYPE_TRIGGER_F+EFFECT_TYPE_SINGLE)
	e4:SetCode(EVENT_SPSUMMON_SUCCESS)
	e4:SetTarget(c100911027.tdtg)
	e4:SetOperation(c100911027.tdop)
	c:RegisterEffect(e4)
end
function c100911027.spcon(e,c)
