...
function c80001045.initial_effect(c)
	--fusion material
	c:EnableReviveLimit()
...
function c80001045.val(e,c)
	return Duel.GetMatchingGroupCount(c80001045.filter,c:GetControler(),0,LOCATION_GRAVE+LOCATION_MZONE,nil)*1000
end
function c80001045.filter(c)
	return c:IsRace(RACE_DRAGON) and (c:IsLocation(LOCATION_GRAVE) or c:IsFaceup())
end
function c80001045.target(e,c)
	return c:IsRace(RACE_DRAGON)
end
function c80001045.aclimit(e,re,tp)
