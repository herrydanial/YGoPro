...
function c10000020.initial_effect(c)
	...
	e10:SetRange(LOCATION_MZONE+LOCATION_DECK+LOCATION_HAND)
	e10:SetCode(EFFECT_IMMUNE_EFFECT)
	e10:SetValue(c10000020.efilter)
...
function c10000020.atkfilter(c,e,tp)
	return c:IsControler(tp) and c:IsPosition(POS_FACEUP_ATTACK+POS_FACEUP_DEFENSE) and (not e or c:IsRelateToEffect(e))
end
