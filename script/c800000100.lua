...
function c800000100.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(800000100,0))
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetCountLimit(1)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCost(c800000100.cost)
	e1:SetTarget(c800000100.target)
	e1:SetOperation(c800000100.operation)
	c:RegisterEffect(e1)
end
function c800000100.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c800000100.operation(e,tp,eg,ep,ev,re,r,rp,chk)
