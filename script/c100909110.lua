...
--Tramid Fortress
--Script by nekrozar
function c100909110.initial_effect(c)
	--Activate
	...
	e4:SetDescription(aux.Stringid(100909110,0))
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e4:SetProperty(EFFECT_FLAG_DELAY+EFFECT_FLAG_CARD_TARGET)
	e4:SetCode(EVENT_TO_GRAVE)
	e4:SetCountLimit(1,100909110)
	e4:SetCondition(c100909110.thcon)
	e4:SetTarget(c100909110.thtg)
	e4:SetOperation(c100909110.thop)
	c:RegisterEffect(e4)
end
function c100909110.thcon(e,tp,eg,ep,ev,re,r,rp)
...
function c100909110.thtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c100909110.thfilter,tp,LOCATION_GRAVE,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectTarget(tp,c100909110.thfilter,tp,LOCATION_GRAVE,0,1,1,nil)
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,g,1,0,0)
end
function c100909110.thop(e,tp,eg,ep,ev,re,r,rp)
