...
function c100419024.initial_effect(c)
	--activate
...
function c100419024.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c100419024.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TARGET)
	Duel.SelectTarget(tp,c100419024.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil)
end
function c100419024.activate(e,tp,eg,ep,ev,re,r,rp)
