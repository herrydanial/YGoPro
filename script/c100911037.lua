...
--Script by dest
function c100911037.initial_effect(c)
	c:EnableReviveLimit()
...
function c100911037.retreg(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetTarget(c100911037.rettg)
	e1:SetOperation(c100911037.retop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	c:RegisterEffect(e2)
end
function c100911037.rettg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
...
function c100911037.retop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
