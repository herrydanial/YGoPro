...
function c101001035.initial_effect(c)
	c:EnableReviveLimit()
	...
	e2:SetCondition(c101001035.spcon)
	c:RegisterEffect(e2)
	--destroy
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringid(101001035,0))
	...
	e3:SetCost(c101001035.descost)
	e3:SetTarget(c101001035.destg)
	e3:SetOperation(c101001035.desop)
	c:RegisterEffect(e3)
end
function c101001035.spcon(e,c)
