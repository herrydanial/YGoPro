...
function c13720013.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	(Duel.GetLocationCount(tp,LOCATION_MZONE)>-1 and Duel.IsExistingMatchingCard(c13720013.filter,tp,LOCATION_MZONE,0,1,nil,e,tp)) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,1,tp,LOCATION_EXTRA)
end
function c13720013.activate(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0 then 
	local g=Duel.SelectMatchingCard(tp,c13720013.filter,tp,LOCATION_MZONE,0,1,1,nil,e,tp)
