...
function c100217006.pentg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c100217006.penfilter,tp,LOCATION_PZONE,0,1,nil,e,tp) end
...
function c100217006.penop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c100217006.penfilter,tp,LOCATION_PZONE,0,1,1,nil,e,tp)
