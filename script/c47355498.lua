...
function c47355498.initial_effect(c)
	...
	e4:SetTargetRange(LOCATION_GRAVE+LOCATION_MZONE+LOCATION_HAND+LOCATION_DECK+LOCATION_SZONE,0)
	e4:SetCondition(c47355498.contp)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
	e5:SetTargetRange(0,LOCATION_GRAVE+LOCATION_MZONE+LOCATION_HAND+LOCATION_DECK+LOCATION_SZONE)
