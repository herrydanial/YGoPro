...
--Script by dest
function c100911023.initial_effect(c)
	--spirit return
	...
	e2:SetDescription(aux.Stringid(100911023,0))
	...
	e2:SetCondition(c100911023.condition)
	e2:SetTarget(c100911023.target)
	e2:SetOperation(c100911023.operation)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
...
function c100911023.operation(e,tp,eg,ep,ev,re,r,rp)
