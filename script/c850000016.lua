--名推理
function c850000016.initial_effect(c)
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetTarget(c850000016.target)
	e1:SetOperation(c850000016.operation)
	c:RegisterEffect(e1)
end
function c850000016.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c850000016.operation(e,tp,eg,ep,ev,re,r,rp)
